/**
 * Backend-neutral session boundary used by the Claude adapter, manager, and UI.
 */
...
export interface SubagentBackend {
  ...
  /** Fast binary availability probe; query failures report authentication issues. */
