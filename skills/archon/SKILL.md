...
compatibility: Upstream Archon snapshot; setup guides assume the Archon repository and some Claude Code-specific interaction/background-task tools. Not enabled automatically by this Pi package.
---

# Archon CLI Skill

> **Compatibility note:** This is an attributed upstream snapshot. Review the current [Archon repository](https://github.com/coleam00/Archon) before setup. Some setup instructions use Claude Code-specific tools and are not directly executable in Pi.
